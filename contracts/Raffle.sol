...
error Raffle__NotUpkeeped(uint256 currentBalance, uint256 numPlayers, uint256 raffleState);
...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function performUpkeep(bytes memory /* performData */) external override {
        ...
        if(!upkeepNeeded) {
            revert Raffle__NotUpkeeped(address(this).balance, s_players.length, uint256(s_raffleState));
        }
